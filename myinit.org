...
(defun mkm/org-refile-in-file (&optional prefix)
  ...
  (interactive)
  (let ((org-refile-targets `(("t_work.org" :regexp . ".*p_.*$")("t_work.org" :todo . "PROJ")("t_work.org" :regexp . "* AOR.*$"))))
...
(setq org-agenda-custom-commands
      '(("C" "Chooser"
        ...
        ("w" "Work"
         (
          (tags-todo "-home&-tools&-learning&-eros&-fict/!NEXT|WAITING|SOMEDAY"
                     ((org-agenda-sorting-strategy '(todo-state-up priority-down))
                      (org-agenda-skip-function 'my-skip-inside-waits)
                      (org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-overriding-header "Current Tasks:")))
          (tags-todo "-home&-tools&-learning&-eros&-fict&LEVEL=2/PROJ"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-overriding-header "Active Projects:")))
          (agenda "" ((org-agenda-span 1)))
          (tags-todo "-learning&-home&-tools&-eros&-fict/!WAITING|SOMEDAY"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-sorting-strategy '(todo-state-up priority-down))
                      (org-agenda-skip-function 'my-skip-waiting-projects)
                      (org-agenda-overriding-header "Waiting Tasks:")))
          (tags-todo "-learning&-home&-tools&-eros&-fict&+{^p_.*}&LEVEL=2/WAITING"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-overriding-header "Projects (Waiting):")))
          (tags-todo "-admin&-learning&-home&-tools&-eros&-fict/!TODO|WAITING|SOMEDAY"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-sorting-strategy '(todo-state-up priority-down))
                      (org-agenda-skip-function 'my-skip-inside-waits)
                      (org-agenda-overriding-header "Task Pool:")))))
        ...
        ("e" "Eros"
         (
          (tags-todo "eros/!NEXT|WAITING|SOMEDAY"
                     ((org-agenda-sorting-strategy '(todo-state-up priority-down))
                      (org-agenda-skip-function 'my-skip-inside-waits)
                      (org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-overriding-header "Current:")))
          (tags-todo "eros&LEVEL=2/PROJ"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-overriding-header "Active Projects:")))
          (tags-todo "eros&tools/!TODO|WAITING|SOMEDAY"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-skip-function 'my-skip-inside-waits)
                      (org-agenda-sorting-strategy '(todo-state-up priority-down))
                      (org-agenda-overriding-header "Tools:")))
          (tags-todo "eros/!TODO|WAITING|SOMEDAY"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-skip-function 'my-skip-inside-waits)
                      (org-agenda-sorting-strategy '(todo-state-up priority-down))
                      (org-agenda-overriding-header "Eros Tasks:")))
          (tags-todo "eros/!WAITING|SOMEDAY"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-sorting-strategy '(todo-state-up priority-down))
                      (org-agenda-skip-function 'my-skip-waiting-projects)
                      (org-agenda-overriding-header "Waiting Tasks:")))))
         ...
         (
          ...
          (tags-todo "fict&tools/!TODO|WAITING|SOMEDAY"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-skip-function 'my-skip-inside-waits)
                      (org-agenda-sorting-strategy '(todo-state-up priority-down))
                      (org-agenda-overriding-header "Fiction Tools:")))
          (tags-todo "fict/!TODO|WAITING|SOMEDAY"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-skip-function 'my-skip-inside-waits)
                      (org-agenda-sorting-strategy '(todo-state-up priority-down))
                      (org-agenda-overriding-header "Fiction Tasks:")))
        ...
        ("c" "Combo"
         (
          (tags-todo "eros|fict/!NEXT|WAITING|SOMEDAY"
                     ((org-agenda-sorting-strategy '(todo-state-up priority-down))
                      (org-agenda-skip-function 'my-skip-inside-waits)
                      (org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-overriding-header "Combo Current:")))
          (tags-todo "eros|fict&LEVEL=2/PROJ"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-overriding-header "Active Projects:")))
          (tags-todo "eros|fict&tools/!TODO|WAITING|SOMEDAY"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-skip-function 'my-skip-inside-waits)
                      (org-agenda-sorting-strategy '(todo-state-up priority-down))
                      (org-agenda-overriding-header "Combo Tools:")))
          (tags-todo "eros|fict/!TODO|WAITING|SOMEDAY"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-skip-function 'my-skip-inside-waits)
                      (org-agenda-sorting-strategy '(todo-state-up priority-down))
                      (org-agenda-overriding-header "Combo Tasks:")))
          (tags-todo "eros|fict/!WAITING|SOMEDAY"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-sorting-strategy '(todo-state-up priority-down))
                      (org-agenda-skip-function 'my-skip-waiting-projects)
                      (org-agenda-overriding-header "Waiting Tasks:")))))
        ("p" "Project View"
          (
          (tags-todo "-learning&-home&-tools&-eros&-fict&LEVEL=2/PROJ"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-overriding-header "Active Projects:")))
          (tags-todo "-learning&-home&-tools&-eros&-fict&+{^p_.*}&LEVEL=2/WAITING"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-overriding-header "Waiting Projects:")))
          (tags-todo "-learning&-home&-tools&-eros&-fict&+{^p_.*}&LEVEL=2/SOMEDAY"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-sorting-strategy '(todo-state-up priority-down))
                      (org-agenda-overriding-header "Someday Projects:")))
          (tags-todo "-learning&-home&-tools&-eros&-fict/!NEXT|WAITING|SOMEDAY"
                     ((org-agenda-prefix-format "%-16:c%?-12t% s")
                      (org-agenda-sorting-strategy '(todo-state-up priority-down))
                      (org-agenda-skip-function 'my-skip-inside-waits)
                      (org-agenda-overriding-header "Current Tasks:")))))))
...
(setq org-capture-templates
      '(
        ("w" "Work")
	("ww" "Work Entry"
	 entry (file+datetree "~/Documents/org/work/work.org")
	 "* %?\n\n\n%i\n"
	 :empty-lines 1
	 )
	("wt" "Work Todo" entry
	 (file+headline "~/Documents/org/work/t_work.org" "AOR INBOX")
	 "* TODO %?")
        ("p" "Personal")
	("pp" "Personal"
	 entry (file+datetree "~/Documents/org/home/personal.org")
	 "* %?\n\n\n%i\n"
	 :empty-lines 1
	 )
	("pt" "Personal Todo"
	 entry (file+headline "~/Documents/org/work/t_personal.org" "AOR INBOX")
	 "* TODO %?"
	 )
        ("f" "Fiction and Writing")
	("ff" "Fiction"
	 entry (file+datetree "~/Documents/org/fiction/fiction.org")
	 "* %?\n\n\n%i\n"
	 :empty-lines 1
	 )
	("ft" "Fiction Todo" entry
	 (file+headline "~/Documents/org/work/t_f.org" "Todo")
	 "* TODO %?")
        ("e" "E Fiction and Writing")
	("ee" "Erotica" 
        entry (file+headline"~/Documents/org/fiction/eros.org" "Notes")
	 "* %?\n\n\n%i\n"
	 :empty-lines 1)
	("et" "Erotica Todo" 
        entry (file+headline "~/Documents/org/work/t_e.org" "Todo")
	 "* TODO %?")
	("M" "eMacs"
	...
	("s" "System"
	 entry (file+datetree "~/Documents/org/home/spec.org" "Notes")
	 "* %?\n\n\n%i\n"
	 :empty-lines 1)
	))
#+END_SRC
